...
import { FormFieds, RestOptions, Tools } from "./FormInterfaces";
...
import AsyncSelect from "./components/AsyncComponents/AsyncSelect";
...
const Formik_Control = ({
  ...
  switch (control) {
    ...
    case "inputReq":
      return <InputRequired rest={rest} styles={styles} formik={formik} />;
    case "inputState":
    ...
    case "asyncSelect":
      return <AsyncSelect rest={rest} formik={formik} />;
    case "amount":
      return <Amount_Input rest={rest} tools={tools} />;
    case "radio":
      return <Radio rest={rest} formik={formik} styles={styles} />;
    case "custom":
